...
class CommonView extends Component {
 ...
 changeQuery = (query) => {
  ...
  render() {
    ...
    return <div><Card style={{ ...bodyStyle, minHeight:"130vh"}}>
        ...
        <Card style={{paddingBottom:5,paddingLeft:5}}>
          ...
          >
            <Menu>
              ...
              <MenuItem value={2} primaryText="- The Stationers' Register" onClick={ (e) => {this.props.goToUrl("/browser/1"); this.handleRequestClose()}}/>
              <MenuItem value={3} primaryText="- The Stationers' Company" onClick={ (e) => {this.props.goToUrl("/browser/1"); this.handleRequestClose()}}/>
              <MenuItem value={4} primaryText="- History of Copyright" onClick={ (e) => {this.props.goToUrl("/browser/1"); this.handleRequestClose()}}/>
              <MenuItem value={5} primaryText="- Bibliography" onClick={ (e) => {this.props.goToUrl("/browser/1"); this.handleRequestClose()}}/>
              <Divider /><Divider /><Divider />
              <MenuItem value={6} primaryText="Project" onClick={ (e) => {this.props.goToUrl("/project"); this.handleRequestClose()}}/>
              <MenuItem value={7} primaryText="- History" onClick={ (e) => {this.props.goToUrl("/browser/1"); this.handleRequestClose()}}/>
              <MenuItem value={8} primaryText="- Editorial" onClick={ (e) => {this.props.goToUrl("/browser/1"); this.handleRequestClose()}}/>
              <MenuItem value={9} primaryText="- Technical" onClick={ (e) => {this.props.goToUrl("/browser/1"); this.handleRequestClose()}}/>
              <MenuItem value={10} primaryText="- Credits" onClick={ (e) => {this.props.goToUrl("/browser/1"); this.handleRequestClose()}}/>
              <MenuItem value={11} primaryText="- Permissions" onClick={ (e) => {this.props.goToUrl("/browser/1"); this.handleRequestClose()}}/>
            </Menu>
          </Popover>
